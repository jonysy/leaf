...
#![feature(crate_in_paths, specialization)]
...
pub mod cerealization_protocol;
pub mod layers;
pub mod solvers;
pub mod typedefs;
pub mod weight;

// TODO the `capnp` suffix shouldn't be required..
pub(crate) use self::cerealization_protocol as cerealization_protocol_capnp;